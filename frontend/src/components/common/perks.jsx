    ...
    slots: [
      {
        runes: [
          ...
          },
          {
            ...
            name: "선제공격",
            shortDesc:
              "적 챔피언 1명에게 기본 공격이나 스킬로 피해를 입기 전 또는 전투 시작 0.25초 내에 해당 적 챔피언에게 기본 공격이나 스킬로 피해를 입히면 5골드를 획득하고 3초 동안 선제공격 효과를 얻어 자신의 기본 공격이나 스킬이 모든 챔피언에게 10%의 추가 피해를 입히며 입힌 추가 피해량만큼(원거리 챔피언 70%) 골드를 획득합니다.",
            longDesc:
              "적 챔피언 1명에게 기본 공격이나 스킬로 피해를 입기 전 또는 전투 시작 0.25초 내에 해당 적 챔피언에게 기본 공격이나 스킬로 피해를 입히면 5골드를 획득하고 3초 동안 선제공격 효과를 얻어 자신의 기본 공격이나 스킬이 모든 챔피언에게 10%의 추가 피해를 입히며 입힌 추가 피해량만큼(원거리 챔피언 70%) 골드를 획득합니다.",
          },
        ],
        ...
        runes: [
          {
            ...
            longDesc: "재사용 대기시간 감소 +5%<br>최대 재사용 대기시간 감소 +5%<br>소환사 주문 재사용 대기시간 감소 +5%<br>아이템 재사용 대기시간 감소 +5%",
          },
          {
            id: 8410,
            ...
            longDesc: "적 챔피언에게 이동 방해기를 맞히고 해당 적에게 이동할 때, 또는 이동 방해기에 맞은 근처의 아군 챔피언에게 이동할 때 이동 속도가 15% 증가합니다. <br><br>범위: 1000",
          },
          {
            id: 8352,
            key: "TimeWarpTonic",
    ...
    slots: [
      {
        runes: [
          ...
          },
          {
            ...
            name: "정복자",
            shortDesc: "적 챔피언 공격 시 적응형 능력치 중첩 획득. 10회 중첩 시 챔피언 대상 피해량의 일부만큼 체력 회복",
            longDesc:
      ...
      },
      {
        runes: [
          ...
          },
          {
            ...
            longDesc: "처치 관여 시 최대 마나 또는 기력의 20%를 회복하고 최대 마나를 100(최대 500)만큼, 최대 기력을 10(최대 50)만큼 증가시킵니다. ",
          },
        ],
      },
      {
    ...
    slots: [
      {
        runes: [
          ...
          },
          {
            ...
            name: "수호자",
            shortDesc: "스킬 대상으로 지정한 아군과 가까운 아군을 보호. 자신 또는 보호받는 아군이 피해를 입으면 둘 다 이동 속도 증가 및 보호막 획득",
            longDesc:
        ...
        runes: [
          {
            ...
            name: "사전 준비",
            shortDesc: "10분 후 방어력 +9 및 마법 저항력 +9 증가와 동시에 방어력 및 마법 저항력 5% 증가",
            longDesc: "10분 후 방어력 +9 및 마법 저항력 +9 증가와 동시에 방어력 및 마법 저항력 5% 증가",
          },
          {
            id: 8444,
            key: "SecondWind",
      ...
      },
      {
        runes: [
          ...
          },
          {
            ...
            name: "소생",
            shortDesc: "자신이 사용하거나 받는 회복과 보호막의 효과 5% 강화. 체력이 낮은 대상에게는 효과가 10% 증가",
            longDesc: "자신이 사용하거나 받는 회복과 보호막 효과가 5% 강화됩니다. 체력이 40% 이하인 대상에게는 이 효과가 10% 증가합니다.",
          },
          {
            id: 8242,
            key: "Unflinching",
            ...
            name: "불굴의 의지",
            shortDesc: "소환사 주문을 사용한 후 잠시 동안 강인함 및 둔화 저항 증가. 또한 소환사 주문이 재사용 대기 상태가 될 때마다 강인함 및 둔화 저항 추가 증가 ",
            longDesc: "소환사 주문을 사용한 후 10초 동안 15%의 강인함 및 둔화 저항을 추가로 얻습니다. 또한 소환사 주문이 재사용 대기 상태가 될 때마다 강인함 및 둔화 저항이 10% 증가합니다. ",
          },
        ],
      },
    ],
      ...
      },
      {
        runes: [
          ...
          },
          {
            ...
            name: "빛의 망토",
            shortDesc: "소환사 주문 사용 후 잠시 동안 이동 속도 증가 및 유닛 통과 가능",
            longDesc:
      ...
      },
      {
        runes: [
          ...
          },
          {
            ...
            name: "기민함",
            shortDesc: "모든 추가 이동 속도 효과 7% 증가 및 이동 속도 1% 증가",
            longDesc: "모든 추가 이동 속도 효과가 7% 증가하고 1%의 추가 이동 속도를 얻습니다.",
          },
          {
            id: 8233,
            key: "AbsoluteFocus",
      ...
      },
      {
        runes: [
          ...
          },
          {
            ...
            name: "폭풍의 결집",
            shortDesc: "게임 중 아이템에 따라 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Adaptive'>적응형</lol-uikit-tooltipped-keyword> 공격력 또는 주문력 획득량 증가",
            longDesc:
